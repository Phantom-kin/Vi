    ...
    try {
      ...
      if (contentType && contentType.startsWith('image')) {
        ...
        await m.bot.sendFromUrl(
          m.from,
          photoUrl,
          " The Cosmo Nation generated this photo:",
          m,
          {},
          "image"
        );
...
cmd({
  ...
  try {
    ...
    if (!_0x680da4 || !pmtypes.includes(_0x680da4?.mtype)) {
      return _0x4e4351.reply("*_Bruhh, Reply To An Image/Video!_*");
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x7d6de1 || !pmtypes.includes(_0x7d6de1?.mtype)) {
      return _0xbda24.reply("*_Bruhh, Reply To An Image/Video/Audio!_*");
    }
...
smd({
  ...
  try {
    ...
    let { data: _0x44f98c } = await axios.get("https://api.github.com/repos/Phantom-kin/Cosmo-Hunter");
    
    let _0x1c73f9 = (`
ℭ𝔬𝔰𝔪𝔬-ℌ𝔲𝔫𝔱𝔢𝔯 𝔞 𝔰𝔦𝔪𝔭𝔩𝔢 𝔚𝔥𝔞𝔱𝔰𝔄𝔭𝔭 𝔟𝔬𝔱 𝔄𝔯𝔦𝔰𝔢𝔡 𝔟𝔶 𝕻𝖍𝖆𝖓𝖙𝖔𝖒 𝔞𝔫𝔡 𝔇𝔢𝔭𝔩𝔬𝔶𝔢𝔡 𝔟𝔶 𝕻𝖍𝖆𝖓𝖙𝖔𝖒.

  *❲❒❳ 𝕊𝕋𝔸ℝ𝕊:* ${_0x44f98c.stargazers_count} stars
  *❲❒❳ 𝔽𝕠𝕣𝕜𝕤:* ${_0x44f98c.forks_count} forks
  *❲❒❳ 𝔸𝕦𝕥𝕙𝕠𝕣:* 𝕻𝖍𝖆𝖓𝖙𝖔𝖒
  *❲❒❳ 𝔸𝕣𝕚𝕤𝕖𝕕 𝕆𝕟:* ${new Date(_0x44f98c.created_at).toLocaleDateString()}
  *❲❒❳ ℝ𝕖𝕡𝕠:* _https://github.com/Phantom-kin/Cosmo-Hunter_
  *❲❒❳ 𝕊𝕔𝕒𝕟:* _${scan}_ ${Config.caption ? `\n\n${Config.caption}` : ""}
    `).trim();
...
smd({
  ...
  use: "277482xxxxx,Your_text_here",
  fromMe: true,
  filename: __filename
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*Cosmo-Hunter • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("Cosmo-Hunter • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("Cosmo-Hunter • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
