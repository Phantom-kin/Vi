let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝕻𝖍𝖆𝖓𝖙𝖔𝖒 𝘾𝙃𝘼𝙉𝙉𝙀𝙇\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VarUpFs2ZjCmM38C463O\n\n ${Config.botname} *©𝕻𝖍𝖆𝖓𝖙𝖔𝖒*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*Cosmo-Hunter CURRENTLY ACTIVE!*";
